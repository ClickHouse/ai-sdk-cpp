 ...
 * 
 * This file is copied from the AWS SDK for C++ source code to work around
 * a Homebrew packaging issue where this header is missing from the installed
 * aws-sdk-cpp package. The bedrock-runtime headers reference this file but
 * Homebrew doesn't include it in the installation.
 * 
 * Source: https://github.com/aws/aws-sdk-cpp/blob/main/src/aws-cpp-sdk-core/include/aws/core/utils/pagination/Paginator.h
 */
